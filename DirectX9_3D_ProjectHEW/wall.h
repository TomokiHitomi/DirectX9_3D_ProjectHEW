...
#define	WALL_POS_UP			(D3DXVECTOR3(PANEL_NUM_X*PANEL_SIZE_X/2-PANEL_SIZE_X/2,0.0f,PANEL_NUM_Z*PANEL_SIZE_Z-PANEL_SIZE_Z/2))	//壁の設置位置　上
#define	WALL_POS_DOWN		(D3DXVECTOR3(PANEL_NUM_X*PANEL_SIZE_X/2-PANEL_SIZE_X/2,0.0f,0.0f-PANEL_SIZE_Z/2))						//壁の設置位置　下
#define	WALL_POS_RIGHT		(D3DXVECTOR3(PANEL_NUM_X*PANEL_SIZE_X-PANEL_SIZE_X/2,0.0f,PANEL_NUM_Z*PANEL_SIZE_Z/2-PANEL_SIZE_Z/2))	//壁の設置位置　右
#define	WALL_POS_LEFT		(D3DXVECTOR3(0.0f-PANEL_SIZE_X/2,0.0f,PANEL_NUM_Z*PANEL_SIZE_Z/2-PANEL_SIZE_Z/2))						//壁の設置位置　左
